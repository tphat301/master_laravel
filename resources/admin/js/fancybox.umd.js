!(function (t, e) {
  ...
  class G extends g {
    ...
    removeSlideEl(t, e = !1) {
      const i = t.el;
      if (!i) return;
      if ((E(i, this.cn("isSelected")), t.isDom && !e))
        return (
          i.removeAttribute("aria-hidden"),
          i.removeAttribute("data-index"),
          E(i, this.cn("isSelected")),
          void (i.style.left = "")
        );
        ...
        for (const i of this.slides)
          i.el &&
            ...
            this.pages[this.page].slides.includes(i)
              ...
              : (i.el.classList.contains(e) &&
                  (E(i.el, e), this.emit("unselectSlide", i)),
  ...
  class ot extends _ {
    ...
    static startFromUrl() {
      if (
        ((ot.hasSilentClose = !1), _t.getInstance() || !1 === _t.defaults.Hash)
      )
        return;
  ...
  class _t extends g {
    ...
    init() {
      ...
      (this.state = it.Init),
        this.attachPlugins(
          Object.assign(Object.assign({}, _t.Plugins), this.userPlugins)
        ),
        this.emit("init"),
        !0 === this.option("hideScrollbar") &&
          (() => {
            ...
            document.documentElement.style.setProperty(zt, `${e}px`),
              n && t.style.setProperty(Lt, `${n}px`),
              t.classList.add(At);
          })(),
        this.initLayout(),
        this.scale();
    ...
    initLayout() {
      ...
      n &&
        ...
        n.classList.toggle(kt, this.isCompact),
        P(n, this.option("mainClass") || ""),
        (this.container = n),
        (this.footer = n.querySelector(".fancybox__footer")),
        i.appendChild(n),
        P(document.documentElement, Ot),
        (Ft && jt) ||
          ((Ft = document.createElement("span")),
          P(Ft, "fancybox-focus-guard"),
          Ft.setAttribute("tabindex", "0"),
          Ft.setAttribute("aria-hidden", "true"),
          Ft.setAttribute("aria-label", "Focus guard"),
          (jt = Ft.cloneNode()),
          null === (t = n.parentElement) ||
            void 0 === t ||
            t.insertBefore(Ft, n),
          null === (e = n.parentElement) || void 0 === e || e.append(jt)),
      ...
      t
        ? (!n || l.indexOf(n) < 0) &&
          ...
          l.length &&
            (i === jt
              ? (h = l[0])
              : (this.lastFocus !== s && i !== Ft) || (h = l[l.length - 1])))
    ...
    isTopmost() {
      var t;
      return (
        (null === (t = _t.getInstance()) || void 0 === t ? void 0 : t.id) ==
        this.id
      );
    }
    animate(t = null, e = "", i) {
    ...
    destroy() {
      ...
      i
        ...
        : (Ft && (Ft.remove(), (Ft = null)),
          ...
          E(document.documentElement, Ot),
          (() => {
            if (!K) return;
            const t = document,
              e = t.body;
            e.classList.remove(At),
              e.style.setProperty(Lt, ""),
              t.documentElement.style.setProperty(zt, "");
          })(),
          this.emit("destroy"));
    }
    static bind(t, e, i) {
      ...
      a.set(s, o),
        _t.openers.set(n, a),
        1 === a.size && n.addEventListener("click", _t.fromEvent);
    }
    static unbind(t, e) {
      let i,
        n = "";
      ...
      s && n && s.delete(n),
        (n && s) ||
          (_t.openers.delete(i), i.removeEventListener("click", _t.fromEvent));
    }
    static destroy() {
      let t;
      for (; (t = _t.getInstance()); ) t.destroy();
      for (const t of _t.openers.keys())
        t.removeEventListener("click", _t.fromEvent);
      _t.openers = new Map();
    }
    static fromEvent(t) {
      if (t.defaultPrevented) return;
      ...
      return u && u.options.triggerEl && r.indexOf(u.options.triggerEl) > -1
        ? void 0
        : (e && (l.startIndex = r.indexOf(e)), _t.fromNodes(r, l));
    }
    ...
    static getSlide() {
      var t;
      return (
        (null === (t = _t.getInstance()) || void 0 === t
          ? void 0
          : t.getSlide()) || null
      );
    }
    ...
    static close(t = !0, ...e) {
      if (t) for (const t of Ht.values()) t.close(...e);
      else {
        const t = _t.getInstance();
        t && t.close(...e);
      }
