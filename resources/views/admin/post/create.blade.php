...
@section('title', 'Thêm ' . config('admin.post.' . $type . '.name'))
...
@section('content')
            ...
            <div class="row">
                <ol class="breadcrumb float-sm-left">
                    ...
                    <li class="breadcrumb-item active">
                        Thêm {{ config('admin.post.' . $type . '.name') }}
                    </li>
                </ol>
            </div>
        </div>
    ...
    <section class="content">
        <form action="{{ route('admin.post.save', ['type' => $type]) }}" class="validation-form" method="POST"
