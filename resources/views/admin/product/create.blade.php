...
@section('title', 'Thêm' . config('admin.' . $type . 'name'))
...
@section('content')
    ...
    <section class="content">
        <form action="{{ route('admin.product.save') }}" class="validation-form" method="POST"
                ...
                <div class="col-xl-4">
                                    ...
                                    @if ($row1->count() > 0)
                                        <div class="form-group col-xl-6 col-sm-4">
                                            ...
                                            <select id="id_parent1" name="id_parent1"
                                                class="form-control select2 filter-category select2-hidden-accessible"
                    ...
                    <div class="card card-primary card-outline text-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                @if (config('admin.' . $type . '.code') === true)
                                    <div class="form-group col-md-6">
                                ...
                                @endif
                                @if (config('admin.' . $type . '.regular_price') === true)
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control format-price regular_price text-sm"
                                                name="regular_price" id="regular_price" placeholder="Giá bán" />
                                            <div class="input-group-append">
