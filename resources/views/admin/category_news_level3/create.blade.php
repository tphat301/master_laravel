...
@section('content')
    ...
    <section class="content">
        <form action="{{ route('admin.category_news' . $level . '.save') }}" class="validation-form" method="POST"
            ...
            <div class="card-footer text-sm sticky-top">
                ...
                <a class="btn btn-sm bg-gradient-danger" href="{{ route('admin.category_news' . $level . '') }}"
                    title="Thoát">
