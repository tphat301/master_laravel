...
@section('content')
    ...
    <section class="content">
        {!! Form::open([
            ...
            'route' => ['admin.news.update', $row->id],
                                ...
                                @if ($row1->count() > 0)
                                    <div class="form-group col-xl-6 col-sm-4">
                                        ...
                                        <select id="id_parent1" name="id_parent1"
                                            ...
                                            data-url="{{ route('admin.news.filter_category') }}" data-level="1"
                                            data-child="id_parent2" tabindex="-1" aria-hidden="true">
                                            <option value="0">
                                                Chọn danh mục
                                            </option>
                                            @foreach ($row1 as $v1)
                                ...
                                <div class="photoUpload-detail" id="photoUpload-preview1">
                                    @if (!empty($row->photo1))
                                        <img class="rounded img-preview img-fluid"
                                            src="{{ url("public/upload/news/$row->photo1") }}"
                                            alt="{{ $row->title }}" />
                                        <a class="delete-photo"
                                            href="{{ route('admin.news.delete_photo', ['id' => $row->id, 'action' => 'photo1']) }}"
                        ...
                        <div class="card-body">
                            <div class="photoUpload-zone">
                                <div class="photoUpload-detail" id="photoUpload-preview2">
                                    @if (!empty($row->photo2))
                                        <img class="rounded img-preview img-fluid"
                                            src="{{ url("public/upload/news/$row->photo2") }}"
                                            alt="{{ $row->title }}" />
                                        <a class="delete-photo"
                                            href="{{ route('admin.news.delete_photo', ['id' => $row->id, 'action' => 'photo2']) }}"
                                            style="cursor: pointer" title="Xóa hình ảnh">
                                            <i class="far fa-trash-alt text-white"></i>
                                        </a>
                                    @else
                        ...
                        <div class="card-body">
                            <div class="photoUpload-zone">
                                <div class="photoUpload-detail" id="photoUpload-preview3">
                                    @if (!empty($row->photo3))
                                        <img class="rounded img-preview img-fluid"
                                            src="{{ url("public/upload/news/$row->photo3") }}"
                                            alt="{{ $row->title }}" />
                                        <a class="delete-photo"
                                            href="{{ route('admin.news.delete_photo', ['id' => $row->id, 'action' => 'photo3']) }}"
                                            style="cursor: pointer" title="Xóa hình ảnh">
                                            <i class="far fa-trash-alt text-white"></i>
                                        </a>
                                    @else
                        ...
                        <div class="card-body">
                            <div class="photoUpload-zone">
                                <div class="photoUpload-detail" id="photoUpload-preview4">
                                    @if (!empty($row->photo4))
                                        <img class="rounded img-preview img-fluid"
                                            src="{{ url("public/upload/news/$row->photo4") }}"
                                            alt="{{ $row->title }}" />
                                        <a class="delete-photo"
                                            href="{{ route('admin.news.delete_photo', ['id' => $row->id, 'action' => 'photo4']) }}"
                                            style="cursor: pointer" title="Xóa hình ảnh">
                                            <i class="far fa-trash-alt text-white"></i>
                                        </a>
                                    @else
            ...
            <div class="card card-primary card-outline text-sm">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        {!! Form::open([
                            'name' => 'dropzoneFrom',
                            'route' => ['admin.news.gallery', $row->id],
                            'id' => 'dropzoneFrom',
                                    ...
                                    <li
                                        ...
                                        <div class="jFiler-item-container position-relative">
                                            <div class="jFiler-item-inner">
                                                ...
                                                <a href="{{ route('admin.news.gallery.delete', ['id' => $gallery->id, 'photo' => $gallery->photo]) }}"
                                                ...
                                                <input type="number"
                                                    ...
                                                    data-url="{{ route('admin.news.gallery.number', ['id' => $gallery->id]) }}"
                                                ...
                                                <input type="text"
                                                    ...
                                                    data-url="{{ route('admin.news.gallery.title', ['id' => $gallery->id]) }}"
        ...
        {!! Form::open([
            'name' => 'form-schema',
            'route' => ['admin.news.schema', $row->id],
