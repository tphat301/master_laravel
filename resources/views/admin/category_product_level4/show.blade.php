...
@section('content')
    ...
    <section class="content">
        {!! Form::open([
            ...
            'route' => ['admin.category_product' . $level . '.update', $row->id],
                                ...
                                <div class="photoUpload-detail" id="photoUpload-preview1">
                                    @if (!empty($row->photo1))
                                        <img class="rounded img-preview img-fluid"
                                            src="{{ url('public/upload/category_product' . $level . '/' . $row->photo1) }}"
                                            alt="{{ $row->title }}" />
                                        <a class="delete-photo"
                                            href="{{ route('admin.category_product' . $level . '.delete_photo', ['id' => $row->id, 'action' => 'photo1']) }}"
                        ...
                        <div class="card-body">
                            <div class="photoUpload-zone">
                                <div class="photoUpload-detail" id="photoUpload-preview2">
                                    @if (!empty($row->photo2))
                                        <img class="rounded img-preview img-fluid"
                                            src="{{ url('public/upload/category_product' . $level . '/' . $row->photo2) }}"
                                            alt="{{ $row->title }}" />
                                        <a class="delete-photo"
                                            href="{{ route('admin.category_product' . $level . '.delete_photo', ['id' => $row->id, 'action' => 'photo2']) }}"
                                            style="cursor: pointer" title="Xóa hình ảnh">
                                            <i class="far fa-trash-alt text-white"></i>
                                        </a>
                                    @else
                        ...
                        <div class="card-body">
                            <div class="photoUpload-zone">
                                <div class="photoUpload-detail" id="photoUpload-preview3">
                                    @if (!empty($row->photo3))
                                        <img class="rounded img-preview img-fluid"
                                            src="{{ url('public/upload/category_product' . $level . '/' . $row->photo3) }}"
                                            alt="{{ $row->title }}" />
                                        <a class="delete-photo"
                                            href="{{ route('admin.category_product' . $level . '.delete_photo', ['id' => $row->id, 'action' => 'photo3']) }}"
                                            style="cursor: pointer" title="Xóa hình ảnh">
                                            <i class="far fa-trash-alt text-white"></i>
                                        </a>
                                    @else
                        ...
                        <div class="card-body">
                            <div class="photoUpload-zone">
                                <div class="photoUpload-detail" id="photoUpload-preview4">
                                    @if (!empty($row->photo4))
                                        <img class="rounded img-preview img-fluid"
                                            src="{{ url('public/upload/category_product' . $level . '/' . $row->photo4) }}"
                                            alt="{{ $row->title }}" />
                                        <a class="delete-photo"
                                            href="{{ route('admin.category_product' . $level . '.delete_photo', ['id' => $row->id, 'action' => 'photo4']) }}"
                                            style="cursor: pointer" title="Xóa hình ảnh">
                                            <i class="far fa-trash-alt text-white"></i>
                                        </a>
                                    @else
